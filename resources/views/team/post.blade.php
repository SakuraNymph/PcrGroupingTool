...
.text-overlay {
  ...
  <div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" >
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-col-md12 new">
          <input type="number" name="score" placeholder="预估伤害" lay-verify="required|number" class="layui-input">
        </div>
    </div>

<!--     <div class="layui-form-item">
      <label class="title">难度（1-99）</label>
      <div class="layui-col-md12 new">
          <input type="number" name="difficulty" placeholder="难度" lay-verify="number" class="layui-input">
      </div>
    </div> -->
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-col-md12 new">
        <input type="checkbox" name="auto" lay-skin="switch" lay-filter="switchTest" lay-text="(半)AUTO|手动" value="1">
      </div>
    </div>

    <div class="layui-form-item layui-form-text">
      <label class="title">备注</label>
      <textarea name="remark" placeholder="请输入内容" class="layui-textarea new"></textarea>
    </div>
...
<script type="text/javascript">
  ...
  layui.config({
    ...
    $('.layui-colla-content').on('click', '.container', function() {
      const id     = $(this).find('.role').attr('val');
    ...
    function getRoles(author_id) {
      ...
      $.get("{{ url('get_all_roles') }}", function(data) {
